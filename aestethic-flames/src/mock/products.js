...
export const candles = [
    {
        id: uuidv4(),
        title: "Socrate – Lumină pentru minte și suflet",
        description: "Pentru cei care caută înțelepciunea și contemplarea, lumânarea Socrate este mai mult decât un obiect decorativ—este o invitație la introspecție și gândire profundă. Aprinde-o într-o seară liniștită, lasă-i flacăra să-ți ghideze gândurile și lasă-te purtat de farmecul filosofiei grecești.",
        img: "../src/assets/botez.jpg" ,
        price: 40,
        stock: true
    },
    {
        ...
        img: "../src/assets/simple-candle.jpg" ,
        price: 40, 
        stock: true
    },
    {
    ...
    {
        id: uuidv4(),
        title: "Lumânare rotundă Soare și Lună – Un vis cosmic prins într-o flacără",
        description: "Magia cerului, întruchipată într-o lumânare cu un design spectaculos. Fie că îți dorești să îți echilibrezi energia sau să creezi o atmosferă liniștită, această lumânare este alegerea perfectă.",
        img: "../src/assets/simple-candle.jpg" ,
        price: 40, 
        stock: true
    },
    {
        id: uuidv4(),
        title: "Lumânare trandafir în formă de inimioară",
        description: "Ce poate fi mai romantic decât un trandafir care nu se ofilește niciodată? Această lumânare aduce căldura iubirii în inima ta și a celor dragi. Fie că o oferi persoanei iubite sau îți dorești să-ți înfrumusețezi spațiul cu un simbol al pasiunii, această lumânare va lumina fiecare moment special.",
        img: "../src/assets/simple-candle.jpg" ,
        price: 40, 
        stock: false
    },
    {
        id: uuidv4(),
        title: "Îngeraș mic – O lumină divină care îți veghează sufletul",
        description: "O lumânare delicată, cu un simbol puternic al speranței și protecției. Perfectă pentru un moment de reflecție sau pentru a oferi un cadou cu semnificație profundă celor dragi.",
        img: "../src/assets/simple-candle.jpg" ,
        price: 40, 
        stock: false
    },
...
export const testimonials = [
    {
        id:uuidv4(),
        title: "Papucei de bebeluși – Primii pași în lumină și iubire",
        description: "Delicatețe și puritate într-o lumânare adorabilă! Acești papucei simbolizează primii pași ai unui suflet nou în lume, fiind o mărturie perfectă pentru un botez de neuitat.",
        img: "../src/assets/nunta.jpg",
        price: 30,
        stock: true,
    },
    {
        id:uuidv4(),
        title: "Bebeluș îngeraș ținut în palme",
        description: "O imagine a inocenței pure și a protecției divine. Această lumânare emoționantă este simbolul iubirii necondiționate și al grijii supreme.",
        img: "../src/assets/nunta.jpg",
        price: 30,
        stock: true,
    ...
    {
        id:uuidv4(),
        title: "Bebeluș care doarme pe perniță",
        description: "Un simbol al liniștii și al purității, această lumânare evocă căldura și dragostea unui somn dulce de copil. Perfectă pentru a aduce o atmosferă de pace și armonie.",
        img: "../src/assets/nunta.jpg",
        price: 30,
        stock: true,
    ...
    },
    {
        id:uuidv4(),
        title: "Îngeraș ",
        description: "O lumânare delicată care aduce un strop de magie și protecție în casa ta. Ideală pentru momente de reflecție, rugăciune sau ca un dar simbolic pentru cei dragi.",
        img: "../src/assets/nunta.jpg",
        price: 30,
        stock: true,
